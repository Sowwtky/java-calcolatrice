...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Somma: " + CalcoliHelper.somma(29, 30));
		System.out.println("Differenza: " + CalcoliHelper.differenza(29, 30));
		System.out.println("Moltiplicazione: " + CalcoliHelper.moltiplicazione(29, 30));
